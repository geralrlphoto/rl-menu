      ...
      <div className="max-w-[800px] mx-auto px-10 py-12 print:px-8 print:py-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed mb-4">
            O presente contrato tem por objeto a prestação de serviços de fotografia e/ou vídeo pelo CONTRATADO ao CONTRATANTE, aplicando-se à cobertura de <strong>casamentos</strong> e <strong>batizados</strong>, para o seguinte evento:
          </p>
