/* ============================================================
   Envolvente editorial das páginas de episódio e de convidados.

   Estava no layout, mas o layout envolve também a /podcast, que serve
   o design aprovado tal e qual e não pode levar um <div> nem estilos
   por cima. Passou a componente, usado só onde faz falta.
   ============================================================ */

export default function Envolvente({ children }: { children: React.ReactNode }) {
  return (
    <div className="pod">
      {children}
