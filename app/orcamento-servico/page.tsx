      ...
      <main className="min-h-screen px-4 py-12 max-w-6xl mx-auto">
        ...
        <div className="print-only max-w-[800px] mx-auto px-10 py-10 text-zinc-900">
          ...
          <section className="mb-10">
            ...
            <div className="total-box rounded-lg px-6 py-5 flex items-center justify-between"
              style={{ background: '#000' }}>
              <div>
                <p className="total-label text-[10px] tracking-[0.4em] uppercase mb-1" style={{ color: '#C9A84C' }}>Total</p>
                <p className="total-sub text-[11px]" style={{ color: '#888' }}>Valores em euros, com IVA quando aplicável.</p>
              </div>
              <p className="total-valor text-4xl font-black tracking-tight" style={{ color: '#C9A84C' }}>{fmt(f.valorTotal)}</p>
            </div>
          </section>
