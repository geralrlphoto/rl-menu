...
const NAV_ITEMS = [
  ...
  { key: 'biblioteca',  label: 'Biblioteca',          icon: '♪', href: '/painel-fotografo/musicas', active: true },
...
export default function MusicasPage() {
  ...
  useEffect(() => {
    ...
    try {
      const raw = localStorage.getItem('painel-fotografo-musicas-covers')
  ...
  function setCustomCover(momento: Momento, dataUrl: string) {
    setCustomCovers(prev => {
      ...
      try { localStorage.setItem('painel-fotografo-musicas-covers', JSON.stringify(next)) } catch {}
      return next
    })
  }
  ...
  function persistUserTracks(all: Track[]) {
    try {
      ...
      localStorage.setItem('painel-fotografo-user-musicas', JSON.stringify(userTracks))
    } catch {}
  }
