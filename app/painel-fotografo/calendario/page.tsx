...
// Gera tarefas automáticas para um user-project (mesma lógica de /painel-fotografo/tarefas)
...
function userTasksToEvents(): CalendarEvent[] {
  ...
  try {
    // 1) Tarefas criadas manualmente em /painel-fotografo/tarefas
    ...
    const deletedRaw = localStorage.getItem('painel-fotografo-deleted-tasks')
...
const NAV_ITEMS = [
  ...
  { key: 'calendario',  label: 'Calendário',          icon: '◉', href: '/painel-fotografo/calendario', active: true },
