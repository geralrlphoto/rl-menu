...
const USER_TASKS_STORAGE_KEY = 'painel-fotografo-user-tasks'
const DELETED_TASKS_STORAGE_KEY = 'painel-fotografo-deleted-tasks'
...
export default function TarefasPage() {
  ...
  function addTask(newTask: Task) {
    ...
    try {
      ...
      localStorage.setItem('painel-fotografo-unseen-tasks', JSON.stringify(arr))
    } catch {}
  }
            ...
            <aside className="lg:col-span-1 flex flex-col gap-4">
              ...
              <Panel title="Calendário" right={
                ...
                <div className="grid grid-cols-7 gap-1">
                  {cells.map((c, i) => {
                    const href = c.iso ? `/painel-fotografo/calendario?date=${c.iso}` : '/painel-fotografo/calendario'
...
function NovaTarefaModal({
  ...
  // Perfil do freelancer (lido de localStorage — definido em /painel-fotografo/dados-pessoais)
      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-gold/30 overflow-hidden"
        ...
        <div className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
          ...
          <p className="text-[10px] text-white/30 text-center">
            ...
            <Link href="/painel-fotografo/dados-pessoais" className="ml-2 underline decoration-white/20 hover:text-gold hover:decoration-gold/40 transition-colors">editar</Link>
          </p>
        </div>
      </div>
    </div>
