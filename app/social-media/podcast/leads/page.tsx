...
/* ============================================================
   Back-office do podcast: contactos de noivos vindos da secção.
   Dentro de /social-media, que o middleware já protege com o cookie
   de admin. O briefing pedia /admin/podcast/leads, mas não existe
   secção /admin neste projeto: esta é a casa equivalente.
   ============================================================ */
  ...
  return (
    <main className="pc-page">
      ...
      <header className="pc-head">
        ...
        <p className="pc-lede">Contactos de noivos que vieram do podcast.</p>
      </header>
      ...
      <style>{`
        ...
        .pc-badge.is-rascunho  { color: var(--ink-4); }
        .pc-badge.is-agendado  { color: var(--gold-soft); border-color: var(--gold-line); }
        .pc-badge.is-publicado { color: #9fd8a8; border-color: rgba(120,210,150,0.35); }

        .pc-atalhos { display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 26px; }
        .pc-atalho {
          font-size: 11px; font-weight: 700;
          letter-spacing: 0.2em; text-transform: uppercase;
        ...
        .pc-atalho:hover { color: var(--ink); border-color: var(--gold-line); }

        .pc-novo { display: flex; gap: 8px; align-items: center; }
        .pc-novo .pc-input { min-width: 260px; }
        @media (max-width: 640px) {
          .pc-bar { flex-direction: column; align-items: stretch; }
          .pc-novo { flex-direction: column; align-items: stretch; }
          .pc-novo .pc-input { min-width: 0; }
        }
        ...
        .pc-slug code { font-size: 12.5px; color: var(--gold-soft); word-break: break-all; }
        .pc-mini {
          font-family: inherit; cursor: pointer;
        ...
        .pc-mini:hover { color: var(--ink); border-color: var(--gold-line); }

        .pc-capa { display: flex; gap: 16px; align-items: flex-start; }
        .pc-capa-img {
          width: 96px; height: 96px; object-fit: cover;
          border-radius: 10px; border: 1px solid var(--gold-faint);
        }
        .pc-capa-vazia {
          width: 96px; height: 96px; flex: none;
          display: flex; align-items: center; justify-content: center;
          border-radius: 10px; border: 1px dashed var(--gold-faint);
          font-size: 11px; color: var(--ink-4);
        }

        /* Tabelas das listas de candidaturas e leads */
        .pc-tabela { width: 100%; border-collapse: collapse; font-size: 13px; }
        .pc-tabela th {
        ...
        .pc-tabela tr:last-child td { border-bottom: 0; }
        .pc-tabela-envolve {
