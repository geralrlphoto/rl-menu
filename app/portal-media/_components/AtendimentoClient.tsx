    ...
    <>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 py-10">
        ...
        <div className="mb-8 border border-white/[0.07] bg-white/[0.02] px-6 py-6 flex flex-col gap-4">
          <p className="text-[9px] tracking-[0.5em] text-white/30 uppercase">O que é o Atendimento?</p>
          ...
          <div className="border border-white/[0.07] bg-white/[0.02] px-5 py-4 flex items-center gap-4 mt-1">
            ...
            <div>
              <p className="text-[9px] tracking-[0.3em] text-white/40 uppercase mb-0.5">Horário de Atendimento</p>
              <p className="text-[13px] font-light text-white/65 leading-relaxed">Segunda a Sexta-feira · 10h00 às 18h00</p>
            </div>
          </div>
        </div>
        ...
        <div className="border border-white/[0.08] bg-white/[0.02] p-7 mb-4">
          <p className="text-[9px] tracking-[0.5em] text-white/30 uppercase mb-5">Gestor de Conta</p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className={`flex items-center gap-4 border border-white/[0.06] px-5 py-3
              ...
              <span className="text-[9px] tracking-[0.4em] text-white/20 uppercase w-14 shrink-0">Email</span>
              {isEditing ? (
                <EditableField
                  value={projeto.gestorEmail}
                  isEditing={true}
                  onChange={v => set('gestorEmail', v)}
                  className="text-[12px] tracking-[0.15em] text-white/45"
                  placeholder="geral.rlmedia@gmail.com"
                  type="email"
                />
              ) : (
                <a href={`mailto:${projeto.gestorEmail}`}
                  className="text-[12px] tracking-[0.15em] text-white/45 hover:text-white/65 transition-colors flex-1">
                  {projeto.gestorEmail}
                </a>
              )}
            ...
            <div className={`flex items-center gap-4 border border-white/[0.06] px-5 py-3
              ${!isEditing ? 'bg-white/[0.01] hover:bg-white/[0.04] transition-colors' : 'bg-white/[0.02]'}`}>
              <span className="text-[9px] tracking-[0.4em] text-white/20 uppercase w-14 shrink-0">Tel.</span>
              {isEditing ? (
                <EditableField
        ...
        <div className="mb-10">
          <div className="mb-6 flex items-center gap-4">
            ...
            <span className="text-[9px] tracking-[0.5em] text-white/15 uppercase">Mensagens</span>
            <div className="h-px flex-1 bg-white/[0.06]" />
          </div>
