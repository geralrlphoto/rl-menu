    ...
    <>
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 py-10">
          ...
          <div className="flex items-center gap-5 mb-6">
            ...
            <div className="flex-1">
              <EditableField
                ...
                className="text-xs tracking-[0.2em] text-white/65 uppercase font-light block"
                placeholder="Nome do gestor"
              />
              <p className="text-xs tracking-[0.2em] text-white/25 mt-0.5">RL Media · Audiovisual</p>
            </div>
          </div>
            ...
            <div className={`flex items-center gap-4 border border-white/[0.06] px-5 py-3
              ...
              {isEditing ? (
                <EditableField
                  ...
                  className="text-xs tracking-[0.15em] text-white/45"
                  placeholder="email@rlmedia.pt"
                  type="email"
                />
              ) : (
                <a href={`mailto:${projeto.gestorEmail}`}
                  className="text-xs tracking-[0.15em] text-white/45 hover:text-white/65 transition-colors flex-1">
                  {projeto.gestorEmail}
                </a>
              )}
        ...
        <a href="https://www.rlmedia.pt" target="_blank" rel="noopener noreferrer"
          ...
          <div>
            <p className="text-xs tracking-[0.3em] text-white/40 uppercase group-hover:text-white/60 transition-colors">RL Media · Audiovisual</p>
            <p className="text-xs tracking-[0.15em] text-white/20 mt-0.5">www.rlmedia.pt</p>
          </div>
