    ...
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2">
      {isEditing ? (
        <>
          <button
            onClick={onCancel}
            className="px-4 py-2 border border-white/15 bg-[#050507] text-white/40 hover:text-white/60 text-lg tracking-[0.3em] uppercase transition-colors"
          >
            Cancelar
          </button>
          <button
            ...
            className="px-5 py-2 border border-emerald-400/40 bg-emerald-400/10 hover:bg-emerald-400/20
                       text-emerald-400/80 hover:text-emerald-400 text-lg tracking-[0.3em] uppercase
          ...
          {isMaster && (
            <button
              ...
              className="px-5 py-2 border border-blue-400/50 bg-blue-400/10 hover:bg-blue-400/20
                         text-blue-400/80 hover:text-blue-400 text-lg tracking-[0.3em] uppercase
                         transition-all disabled:opacity-40"
            >
        ...
        <>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 border border-white/10 bg-[#050507]/90
                       ...
                       text-lg tracking-[0.3em] uppercase transition-all"
