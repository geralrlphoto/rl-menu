    ...
    <main className="min-h-screen bg-[#050507] relative">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 py-10">
        ...
        <div className="border border-white/[0.08] bg-white/[0.02] p-7 mb-4">
          <p className="text-[8px] tracking-[0.5em] text-white/20 uppercase mb-5">Gestor de Conta</p>
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              <p className="text-[12px] tracking-[0.2em] text-white/65 uppercase font-light">{projeto.gestorNome}</p>
          ...
          <div className="flex flex-col gap-3">
            <a href={`mailto:${projeto.gestorEmail}`}
              ...
              <span className="text-[10px] tracking-[0.15em] text-white/45 group-hover:text-white/65 transition-colors">{projeto.gestorEmail}</span>
            ...
            <a href={`tel:${projeto.gestorTelefone}`}
              ...
              <span className="text-[10px] tracking-[0.15em] text-white/45 group-hover:text-white/65 transition-colors">{projeto.gestorTelefone}</span>
              <span className="ml-auto text-white/15 group-hover:text-white/40 transition-colors">→</span>
            </a>
          </div>
        </div>
        ...
        <a href="https://www.rlmedia.pt" target="_blank" rel="noopener noreferrer"
          ...
          <div>
            <p className="text-[10px] tracking-[0.3em] text-white/40 uppercase group-hover:text-white/60 transition-colors">RL Media · Audiovisual</p>
