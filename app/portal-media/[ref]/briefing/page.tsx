      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 py-10">
        ...
        <div className="mb-10">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <span className="text-[8px] tracking-[0.4em] text-emerald-400/60 uppercase">Concluído</span>
          ...
          {[
            ...
            <div key={i} className="border border-emerald-400/12 bg-emerald-400/[0.02] px-6 py-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] tracking-[0.25em] text-white/55 uppercase font-medium mb-1.5">{item.label}</p>
