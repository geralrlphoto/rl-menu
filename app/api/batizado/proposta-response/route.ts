    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#120e09;border:0.5px solid #4a3a1e;">
        ...
        <tr><td style="padding:8px 56px 56px;font-family:Georgia,'Times New Roman',serif;text-align:center;">
          ...
          <p style="margin:0;font-size:38px;font-weight:400;color:#f0e8d8;line-height:1.1;">Proposta (Batizado)</p>
          ...
          <p style="margin:0;font-size:15px;color:#a09070;line-height:1.8;">
            ${confirmou
              ? 'A família <strong style="color:#c9b88a;font-weight:500;">confirmou a proposta</strong><br>através do portal de batizado.'
              : 'A família <strong style="color:#ef4444;font-weight:500;">rejeitou a proposta.</strong><br>Portal de batizado.'}
          </p>
...
export async function POST(req: NextRequest) {
  ...
  const updatedSettings = { ...(row.settings || {}), proposta_resposta: action }
